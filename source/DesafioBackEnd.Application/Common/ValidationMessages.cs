...
public static class ValidationMessages
{
    ...
    public static string InvalidPlan() => "The chosen plan is not valid.";
    public static string NoBikeAvailableToRent() => "There is no bike available to rent.";
    public static string InvalidDate() => "The date is invalid.";
}
